...
export function decryptResponses(responses: string, appletPrivateKey: string, encryption: IAppletEncryption, userPublicKey: string): IResponseItem[] {
    ...
    return JSON.parse(decryptData(responses, AESKey)) as IResponseItem[];
}
